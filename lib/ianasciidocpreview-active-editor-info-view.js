...
export const htmloutputDir =     "/home/ian/ZZZZianasciidocpreview-active-editor-info/";  //   "./";
var consprint =  false;
...
export default class IanasciidocpreviewActiveEditorInfoView {
  ...
  // #################   LOK AT THIS #########################
    ...
    function getTextOpenWrite() {   // function getTextOpenWrite()
      ...
      let htmloutputFile = 'temp/iansasciidocpreviewhtmloutput.html';

      // exported at top const htmloutputDir = "./"; // append / html file with head etc added by getTextOpenWrite.js
      ...
      let htmloutputFileRawFromAsciidocStandaloneUnsafe = 'temp/htmloutputFileRawFromAsciidocStandaloneUnsafe.html';  // file from asciidoctor.js WITH head etc wich will be added by getTextOpeWrite
      ...
      let transformscaleDir = htmloutputDir;    // used to be "./";
...
// <h1>Document title</h1>
      ...
      let htmloutputStandaloneUnsafe = Asciidoctor.convert(asciidocInputFromEditor_words, {   'standalone': true, 'safe': 'unsafe'}); // Works with Asciidoctor NOT asciidoctor
      fs.writeFileSync(htmloutputDir + htmloutputFileRawFromAsciidocStandaloneUnsafe, htmloutputStandaloneUnsafe);
      ...
      /////////////////////////////////////////////////     scrollToHere   //////////////////////////////////////////
          let scrollToHereDir = htmloutputDir;  // used to be  "./";
