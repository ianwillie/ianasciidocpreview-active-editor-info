       ...
       `<html> \n` +
        ...
        //`<div id="insidebody" style=" zoom: ${transformScale}; height=1001px; overflow-y: scroll; overflow-x: scroll;"  > ` +
          ...
          //<div class="article">  ${htmloutput} </div> // no class article in css
            ...
            `<br><br><a href="#mytarget">TEST Click here to jump to href=#mytarget</a> \n` +
            `<br><br><a name="value1">TEST Click here ot jump to name=value1</a>` +
              ...
              `<div id="mytarget">This is div=mytarget.</div > \n` +
